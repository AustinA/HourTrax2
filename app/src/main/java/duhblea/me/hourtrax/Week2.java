...
public class Week2 extends Fragment implements View.OnKeyListener {
    ...
    public static Week2 newInstance(MainActivity aContext) {
        mActivity = aContext;
        Week2 fragment = new Week2();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_week2, container, false);
    ...
    public boolean onKey(View v, int keyCode, KeyEvent event) {
        ...
        if (!monday.getText().toString().equals("")) {
            biweek.setHourValue(2, Biweek.MONDAY, Float.parseFloat(monday.getText().toString()));
        }
        else {
        ...
        if (!tuesday.getText().toString().equals("")) {
            biweek.setHourValue(2, Biweek.TUESDAY, Float.parseFloat(tuesday.getText().toString()));
        }
        else {
        ...
        if (!wednesday.getText().toString().equals("")) {
            biweek.setHourValue(2, Biweek.WEDNESDAY, Float.parseFloat(wednesday.getText().toString()));
        }
        else {
        ...
        if (!thursday.getText().toString().equals("")) {
            biweek.setHourValue(2, Biweek.THURSDAY, Float.parseFloat(thursday.getText().toString()));
        }
        else {
        ...
        if (!friday.getText().toString().equals("")) {
            biweek.setHourValue(2, Biweek.FRIDAY, Float.parseFloat(friday.getText().toString()));
        }
        else {
        ...
        if (!saturday.getText().toString().equals("")) {
            biweek.setHourValue(2, Biweek.SATURDAY, Float.parseFloat(saturday.getText().toString()));
        }
        else {
        ...
        if (!sunday.getText().toString().equals("")) {
            biweek.setHourValue(2, Biweek.SUNDAY, Float.parseFloat(saturday.getText().toString()));
        }
        else {
            biweek.setHourValue(2, Biweek.SUNDAY, 0);
        }

        weekTotal.setText("Hours worked:  " + Float.toString(biweek.calculateWeek2()));
    ...
    private void populateFields() {
        ...
        thursday.setText(biweek.getHours(2, Biweek.THURSDAY) != 0.0
                ? Float.toString(biweek.getHours(2, biweek.THURSDAY)) : "");
        friday.setText(biweek.getHours(2, Biweek.FRIDAY) != 0.0
                ? Float.toString(biweek.getHours(2, biweek.FRIDAY)) : "");
        saturday.setText(biweek.getHours(2, Biweek.SATURDAY) != 0.0
                ? Float.toString(biweek.getHours(2, biweek.SATURDAY)) : "");
        sunday.setText(biweek.getHours(2, Biweek.SUNDAY) != 0.0
                ? Float.toString(biweek.getHours(2, biweek.SUNDAY)) : "");
